...
import { residentService as service } from '../_services'
  ...
  return dispatch => {
    ...
    service.getAll()
      .then(
        ...
        error => dispatch(failure(error+' getting all resident models'))
      )
  }
  ...
  return dispatch => {
    ...
    service.getById(id)
      .then(
        ...
        error => dispatch(failure(error+' in get resident model by id: '+id))
      )
  }
